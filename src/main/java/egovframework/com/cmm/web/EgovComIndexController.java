...
import egovframework.com.cmm.CpyrhtPrtcVO;
import egovframework.com.cmm.IncludedCompInfoVO;
import egovframework.com.cmm.LoginVO;
import egovframework.com.cmm.PolicyVO;
...
public class EgovComIndexController implements ApplicationContextAware, InitializingBean {
	...
	public String homeIndex(ModelMap model) {
		return "redirect:/fisrtHome.do";
	}
	
	@RequestMapping("/cms.do")
	...
	public String smsSend(ModelMap model) {
		return "egovframework/com/cms/smsSend";
	}
	
	@RequestMapping("/sms.do")
	//public String sms(@ModelAttribute("sms") Sms sms, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {	
	public String sms(ModelMap model) throws Exception {
		...
		*/
		return "egovframework/com/cms/sms";
	}
	/*
	@RequestMapping("/index.do")
	...
	@RequestMapping("/listIndvdlInfoPolicy.do")
	public String listIndvdlInfoPolicy(ModelMap model) throws Exception {
		
		PolicyVO policy = egovIndvdlInfoPolicyService.selectIndvdlInfoPolicyListOne();
		
		model.addAttribute("policy",policy);
		
		return "egovframework/com/listIndvdlInfoPolicy";

	}
	
	@RequestMapping("/CpyrhtPrtcPolicyInqire.do")
	public String CpyrhtPrtcPolicyListInqire(ModelMap model) {
		
		CpyrhtPrtcVO cpyrhtPrtc = cpyrhtPrtcPolicyService.selectCpyrhtPrtcPolicyListOne();
		
        model.addAttribute("cpyrhtPrtc", cpyrhtPrtc);
		
		return "egovframework/com/CpyrhtPrtcPolicyListInqire";
