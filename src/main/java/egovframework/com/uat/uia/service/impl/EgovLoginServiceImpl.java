...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	 ...
	 */
    @Override
	public boolean searchId(LoginVO vo) throws Exception {
    	...
    	sndngMailVO.setSj("[전남도립국악단] 아이디를 발송했습니다.");
    	sndngMailVO.setEmailCn("고객님의 아이디는 " + loginVO.getId() + " 입니다.");
    	sndngMailVO.setAtchFileId("");

    	result = egovSndngMailService.sndngMailUnfile(sndngMailVO);
	...
	public boolean searchPassword(LoginVO vo) throws Exception {
    	...
    	sndngMailVO.setDsptchPerson("webmaster");
    	sndngMailVO.setRecptnPerson(vo.getEmail());
    	sndngMailVO.setSj("[전남도립국악단] 임시 비밀번호를 발송했습니다.");
    ...
    public String processLoginIncorrect(LoginVO vo, Map<?,?> mapLockUserInfo) throws Exception{    	
    	...
    	String enpassword = password(vo.getPassword().getBytes());
	...
	@Override
	public LoginVO saltPassword(LoginVO loginVO){
		// TODO Auto-generated method stub
		return (LoginVO) loginDAO.saltPassword(loginVO);
	}
