...
public class EgovMberManageServiceImpl extends EgovAbstractServiceImpl implements EgovMberManageService {
	 ...
	 * @throws Exception
	 */
	public void deleteOutMber(MberManageVO mberManageVO) throws Exception {
		mberManageDAO.deleteOutMber(mberManageVO);
	}
	 ...
	 * @throws Exception
	 */
	public void insertOutMberData(MberManageVO mberManageVO) throws Exception {
		mberManageDAO.insertOutMberData(mberManageVO);
	}

	@Override
	public void updateMberPaid(MberManageVO mberManageVO) {
		mberManageDAO.updateMberPaid(mberManageVO);
	}
