...
public class MberManageDAO extends EgovComAbstractDAO{
     ...
     * @param mberManageVO 일반회원정보
     */
    public void deleteOutMber(MberManageVO mberManageVO) {
        delete("mberManageDAO.deleteOutMber", mberManageVO);
    }
     ...
     * @param mberManageVO 일반회원정보
     */
    public void insertOutMberData(MberManageVO mberManageVO) {
        insert("mberManageDAO.insertOutMberData", mberManageVO);
    }

	public void updateMberPaid(MberManageVO mberManageVO) {
		 update("mberManageDAO.updateMberPaid", mberManageVO); 
