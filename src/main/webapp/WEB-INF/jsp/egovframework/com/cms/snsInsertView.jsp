...
<div class="layout-container">
	<h2>SNS 입력</h2>
	<form:form commandName="snsManageVO" action="/snsInsert.do" name="snsManageVO" method="post" onSubmit="fnUpdate(document.forms[0]); return false;" enctype="multipart/form-data">
		<input type="hidden" name="eduId" id="eduId" value='<c:out value="${snsManageVO.snsId}"/>'/>
		<input type="hidden" name="registId" id="registId" value='<c:out value="${snsManageVO.snsRegistId}"/>'/>
