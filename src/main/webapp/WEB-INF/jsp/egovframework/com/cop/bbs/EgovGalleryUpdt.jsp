                    ...
                    <div class="wTableFrm">
                        ...
                        <c:choose>
							<c:when test="${kid == 'Y' }">
                            	...
                            	<a class="btn_s" href="/cop/bbs/selectArticleList.do?bbsId=<c:out value='${boardMasterVO.bbsId }&type=k'/>" title="목록">목록</a>
							</c:when>
							<c:otherwise>
								<input type="submit" class="s_submit" value="등록" title="등록 버튼" onClick="fn_egov_regist_article(); return false;">
                            	<a class="btn_s" href="/cop/bbs/selectArticleList.do?bbsId=<c:out value='${boardMasterVO.bbsId }'/>" title="목록">목록</a>
							</c:otherwise>
						</c:choose>
