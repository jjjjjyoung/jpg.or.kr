                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <input id="youtube" name="youtube" title="유투브 키값 입력" placeholder="https://www.youtube.com/watch?v= &quot;A1B2C3D4E5F&quot; &lt; 이 부분을 입력하세요." type="text" value="" size="70" maxlength="70">
                                    </td>
                                </tr>
								<tr>
									<th><label for="galYoutube">내용<span class="pilsu">*</span></label></th>
									<td style="height:auto; padding:10px 20px">
										<textarea name="nttCn" title="" cols="300" rows="20" /></textarea>
