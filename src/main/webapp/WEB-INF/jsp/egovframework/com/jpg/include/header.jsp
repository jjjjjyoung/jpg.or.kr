    ...
    <div id="header">
        ...
        <div class="tnb">
            <div class="inner">
                <div class="left">
					<ul>
						<li><a tabindex = "1" href="#go_direct" id="go_di_all2">본문 바로가기</a></li>
						<!--li><a tabindex = "1" href="/home.do" class="atv">전남도립국악단</a></li-->
						<li><a tabindex = "1" href="/kidHome.do" class="jpgfSe02"><img src="/images/egovframework/com/jpg/icon/kid_btn_icon.png" alt="">어린이국악단</a></li>
					</ul>
                </div>
                <div class="right">
					<ul>
						<c:choose>
							...
							<li><a tabindex = "1" href="<%=request.getContextPath() %>/mypage.do" class="mypage">MYPAGE</a></li>
							<li><a tabindex = "1" href="<%=request.getContextPath() %>/uat/uia/actionLogout.do" class="logout">로그아웃</a></li>
						</c:when>
						<c:otherwise>
							<li><a tabindex = "1" href="/uat/uia/egovLoginUsr.do" class="login">로그인</a></li>
							<li><a tabindex = "1" href="javascript:goRegiUsrheader();" class="join">회원가입</a></li>
						</c:otherwise>
						</c:choose>
							<li><a href="" tabindex = "1" title="카카오채널추가"><img src="/images/egovframework/com/jpg/kakao_channel.png" alt=""></a></li>
					</ul>
        ...
        <div id="nav">
            <div class="inner">
                ...
                <h1 class="logo" title="전라남도도립국악단">
                    <a tabindex = "1" href="/home.do"><img src="/images/egovframework/com/jpg/MainLogo.svg" alt="전라남도도립국악단"></a>
                </h1>
                <div id="gnb">
                	<ul>
        ...
        <div class="mbNav wj_mbNav">
            ...
            <div class="ins_you_box_fo">
				<ul>
					<li><a href="/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000055&skin=M"><img src="/images/egovframework/com/jpg/sd_icon01.png" alt=""><span>공연일정</span></a> </li>
					<li><a href="/contents.do?id=ticketing"><img src="/images/egovframework/com/jpg/sd_icon02.png" alt=""><span>공연예매</span></a> </li>
					<li><a href="/contents.do?id=location"><img src="/images/egovframework/com/jpg/sd_icon03.png" alt=""><span>오시는길</span></a></li>
					<li><a href="/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000044"><img src="/images/egovframework/com/jpg/sd_icon04.png" alt=""><span>뉴스레터</span></a></li>
				</ul>
            	<ul class="sns_url_m">
            		<li>
            			<a href="https://www.instagram.com/jeonnam_gugak/">
            				<img src="../../../../images/egovframework/com/jpg/sd_icon05.png" alt="">
            			</a>
            		</li>
            		<li>
            			<a href="https://www.youtube.com/channel/UCwZHHFSbD15bnhBDBV01oBQ/featured">
            				<img src="../../../../images/egovframework/com/jpg/sd_icon06.png" alt="">
            			</a>
            		</li>
					<li>
            			<a href="https://www.instagram.com/jeonnam_gugak/">
            				<img src="../../../../images/egovframework/com/jpg/sd_icon07.png" alt="">
            			</a>
            		</li>
            		<li>
            			<a href="https://www.youtube.com/channel/UCwZHHFSbD15bnhBDBV01oBQ/featured">
            				<img src="../../../../images/egovframework/com/jpg/sd_icon08.png" alt="">
            			</a>
            		</li>
            	</ul>
