                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <c:if test="${boardMasterVO.fileAtchPosblAt == 'Y'}">
									...
									<tr>
										<th>${title}</th>
										<td class="nopd" colspan="3" style="height:auto;">
                        	...
                        	<c:choose>
								<c:when test="${kid == 'Y' }">
									<input type="submit" class="s_submit" value="등록" title="등록 버튼">
                           			<a class="btn_s" href="/cop/bbs/selectArticleList.do?bbsId=<c:out value='${boardMasterVO.bbsId }&type=k'/>" title="목록  버튼">목록</a>
								</c:when>
								<c:otherwise>
									<input type="submit" class="s_submit" value="등록" title="등록 버튼">
