        ...
        <div class="contentWrap" id="go_direct">
	        ...
	        <div class="con01">
	            <div class="inner">
	                ...
	                <c:choose>
						<c:when test="${kid == 'Y' }">
	             			<a href="<c:url value="/cop/bbs/insertArticleView.do?bbsId=${boardMasterVO.bbsId }&type=k"/>">등록</a>
	             		</c:when>
	             		<c:otherwise>
	                ...
	                <div class="gallery" style="position: relative;">
		                           	...
		                           	<div class="overTxt">
		                                <ul>
		                                	...
		                                	<li class="title">${resultInfo.nttSj }</li>
		                                  	...
		                                  	<c:choose>
												<c:when test="${kid == 'Y' }">
													<a href="<c:url value="/cop/bbs/deleteArticle.do?nttId=${resultInfo.nttId }&bbsId=${boardMasterVO.bbsId }&type=k"/>" style="color:white">삭제</a>
													<a href="<c:url value="/cop/bbs/updateArticleView.do?nttId=${resultInfo.nttId }&bbsId=${boardMasterVO.bbsId }&type=k"/>" style="color:white">수정</a>
												</c:when>
												<c:otherwise>
	                    ...
	                    <div class="gall_list">
	                        <div class="slider-nav" style="position: relative;">
	 							<c:forEach var="resultInfo" items="${resultList}" varStatus="status">
	 								<div class="slider"><button tabindex="-1"><img src="/cmm/fms/getImage.do?atchFileId=${resultInfo.atchFileId}" alt="${resultInfo.nttCn }"></button>
	                            	</div>
	 							</c:forEach>
	                        </div>
	                    </div>
