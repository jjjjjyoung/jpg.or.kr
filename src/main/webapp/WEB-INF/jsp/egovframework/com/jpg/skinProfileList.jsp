...
<%-- 												<c:if test="${user.id == 'webmaster'}">
				   	                		...
				   	                		<c:otherwise>		
				   	                			...
				   	                			<div>
				   	                				...
				   	                				<c:choose>
														<c:when test="${kid == 'Y' }">
															<a href="/cop/bbs/selectArticleDetail.do?nttId=${item.nttId}&bbsId=${item.bbsId}&type=k">
														</c:when>
														<c:otherwise>
			            ...
			            <c:if test="${user.id == 'webmaster'}">
					        <div class="btn" style="margin-top: 30px;">
								<span class="btn_b">
									...
									<c:choose>
										<c:when test="${kid == 'Y' }">
											<a href="<c:url value='/cop/bbs/insertArticleView.do?bbsId=${boardMasterVO.bbsId}&type=k' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />">
