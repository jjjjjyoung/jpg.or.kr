		    ...
		    <div class="con01 detail">
		        <div class="inner">
	       		...
	       		<div class="btn">
		       		...
		       		<c:choose>
						<c:when test="${kid == 'Y' }">
							<a style="float:none;position: inherit;" href="<c:url value='/cop/bbs/selectArticleList.do' />?bbsId=${boardMasterVO.bbsId}&type=k"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a>
							<a style="float:none;position: inherit;" href="<c:url value='/cop/bbs/updateArticleView.do' />?nttId=${result.nttId}&bbsId=${boardMasterVO.bbsId}&type=k"  title="<spring:message code="button.update" />  <spring:message code="input.button" />"><spring:message code="button.update" /></a>
							<a style="float:none;position: inherit;" href="<c:url value='/cop/bbs/deleteArticle.do' />?nttId=${result.nttId}&bbsId=${boardMasterVO.bbsId}&type=k"  title="<spring:message code="button.delete" />  <spring:message code="input.button" />"><spring:message code="button.delete" /></a>
						</c:when>
						<c:otherwise>
