        ...
        <div class="contentWrap" id="go_direct">
	                ...
	                <div class="gallery" style="position: relative;">
	                    ...
	                    <div class="gall_list">
	                    	...
	                    	<c:forEach items="${resultList }" var="result">
		                            ...
		                            <p>${result.nttSj }</p>
									<div class="sound_only">${result.nttCn }</div>
		                        	<c:if test="${user.id =='webmaster' }">
	        ...
	        <script>
		       	...
		       	$(document).ready(function(){
					$(document).attr("title","갤러리-영상보기");
					$('.slick-active > div').attr("tabindex","0");
		           	...
		           	$('.slick-next').click(function(){
						...
						var slick_content = $(".slick-center div div .sound_only")[0].innerHTML;
			           	//console.log(slick_content);
			           	$('#youplayer').html('<iframe title="유튜브 동영상 플레이"  width="100%" height="700" src="https://www.youtube.com/embed/'+slick_youtube_key+'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'+slick_content);
		        	...
		        	$('.img_youtube').click(function(){
						...
						var slick_content = $(this).parent("div").find("div.sound_only")[0].innerHTML;
						
		        		//alert($(this).data("img"));
		        		$('#youplayer').html('<iframe title="유튜브 동영상 플레이"  width="100%" height="700" src="https://www.youtube.com/embed/'+$(this).data("img")+'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'+slick_content);
		        		$('.slick-slide').css("opacity", "1");
		        	});
