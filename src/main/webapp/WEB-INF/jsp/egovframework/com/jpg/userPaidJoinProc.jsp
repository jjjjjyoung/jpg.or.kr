    ...
    <div id="container">
        ...
        <div class="contentWrap">
	        <div class="inner">
	            ...
	            <div class="paid-join" id="go_direct">
	                    ...
	                    <div class="sub_title"><p>유료회원가입</p></div>
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="right">
                                        <input title="남" tabindex="0" type="radio" name="gender" id="man" checked/>
                                        <label for="man">남</label>
                                        <input title="여" tabindex="0" type="radio" name="gender" id="woman"/>
                                ...
                                <li>
                                    ...
                                    <div class="right">
                                        <input title="생년월일 입력(연도-월-일)" type="text" id="birthday" name="birthday" placeholder="연도-월-일" value="<c:out value="${paidMemberVO.birthday}"/>"/>
                                        <input type="radio" tabindex="0" name="birth" id="lift" checked/>
                                        <label for="lift" class="lift">양력</label>
                                        <input type="radio" tabindex="0" name="birth" id="lunar"/>
                                ...
                                <li>
                                    ...
                                    <div class="right">
                                        <input title="연락처 입력(000-0000-0000)" type="text"  name="phone" id="phone" placeholder="000-0000-0000" />
                                    </div>
                                </li>
                                 <li>
                                    <div class="left">연락처(유선전화)</div>
                                    <div class="right">
                                        <input title="연락처 입력(000-000-0000)" type="text"  name="tel" id="tel" placeholder="000-000-0000" />
                                    </div>
                                </li>
                                  <li>
                                ...
                                <li>
                                    ...
                                    <div class="right address_box">
                                        ...
                                        <button type="button" onclick="sample6_execDaumPostcode();" class="sty_btn_y2" title="새창열기">주소검색</button>
