...
<div class="main_banner">
    ...
    <div  class="slick-slide" >
    	<c:choose>
    		<c:when test="${fileVO.linkUrl != null}">
				<a class="btn_red" href="<c:out value="${fileVO.linkUrl}"/>" target="_blank">자세히보기</a>
	...
	<div class="slick_nav">
		<div class="slick_btn">
			<button type="button" class="prev material-icons" title="이전"></button>
			<button type="button" class="play material-icons" style="display: none;" title="재생"></button>
			<button type="button" class="pause material-icons" title="정지"></button>
			<button type="button" class="next material-icons" title="다음"></button>
		</div>
	</div>
	<% //} %>
</div>
