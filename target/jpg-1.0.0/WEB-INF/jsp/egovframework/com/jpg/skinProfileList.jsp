		        ...
		        <div class="tab">		        	
		            <div class="inner name_class_box09">
		                ...
		                <div class="selected" id="article1">
		                	<a href="#" title="현재페이지"><h4>예술감독</h4></a>
		                </div>
		                </c:if>
		                
		                <c:if test="${param.bbsId == 'BBSMSTR_000000000050'}">
		                <div class="selected" id="article1">
		                	<a href="#" class="inv_art_direc01"><h4>객원예술감독</h4></a>
		                	<a href="#" class="inv_art_direc02"><h4>예술감독</h4></a>
		                </div>
		                </c:if>
		                
		                <c:if test="${param.bbsId == 'BBSMSTR_000000000050'}">
		                <div id="article6"><a href="#" ><h4>지도교사</h4></a></div>
		                </c:if>
		                <div id="article2"><a href="#" ><h4>창악부</h4></a></div>
		                <div id="article3"><a href="#" ><h4>기악부</h4></a></div>
		                <div id="article4"><a href="#" ><h4>무용부</h4></a></div>
		                <div id="article5"><a href="#" ><h4>사물부</h4></a></div>
		            </div>
		      	<script>
