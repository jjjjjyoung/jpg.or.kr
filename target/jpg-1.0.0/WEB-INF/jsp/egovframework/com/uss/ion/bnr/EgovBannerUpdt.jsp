...
<input type="hidden" name="posblAtchFileNumber" value="1"  >
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<input style="border:0;" type="file" name="file_1" id="egovfile_0" title="<spring:message code="ussIonBnr.bannerUpdt.bannerImage"/>" onchange="fncOnChangeImage();"/> 
				</div>
        		<input style="display: block;" name="bannerImage" id="bannerImage" type="text" title="<spring:message code="ussIonBnr.bannerUpdt.bannerImage"/>" value="<c:out value="${banner.bannerImage}"/>" maxLength="30" readonly="readonly" />
			</td>
		</tr>
		<tr>
			<th><spring:message code="ussIonBnr.bannerUpdt.bannerDc"/></th><!-- 배너설명 -->
			<td class="left">
			    <textarea id="bannerDc" name="bannerDc" title="<spring:message code="ussIonBnr.bannerRegist.bannerDc"/>"><c:out value='${banner.bannerDc}'/></textarea>
			</td>
		</tr>
		<tr>
		...
		<!-- 
		<tr>
			<th><spring:message code="ussIonBnr.bannerUpdt.regDate"/> <span class="pilsu">*</span></th>
			<td class="left">
	...
	<div class="btn">
		...
		<span class="btn_s"><a style="background:#efb98d!important;" href="<c:url value='/uss/ion/bnr/removeBanner.do'/>?bannerId=<c:out value='${bannerVO.bannerId}'/>" onclick="fncBannerDelete(); return false;"><spring:message code="button.delete" /></a></span>
